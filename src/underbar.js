...
(function() {
  ...
  _.map = function(collection, iterator) {
    ...
    _.each(collection, function(el, i, collection) {
      result.push(iterator(el, i, collection));
    });
  ...
  _.every = function(collection, iterator) {
    ...
    return _.reduce(collection, function(validated, current) {
        return iterator(current) ? validated : false;
    }, true);
  };
  ...
  _.some = function(collection, iterator) {
    ...
    return _.reduce(collection, function(isTrue, current) {
      return !!(iterator(current)) || isTrue;
    }, false)
  };
  ...
  _.shuffle = function(array) {
    ...
    _.each(array, function(el, i) {
      var pick = Math.floor(Math.random() * (result.length - i));
      result.push(result.splice(pick,1)[0]);      
    });
